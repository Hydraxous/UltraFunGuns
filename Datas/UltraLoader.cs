...
namespace UltraFunGuns
{
    ...
    public static class UltraLoader
    {
        ...
        public static bool TryLoadVanillaAsset(string key, Type type, out UnityEngine.Object outputObject)
        {
            string text = AssetManager.Instance.assetDependencies[key];
            AssetManager.Instance.LoadBundles(new string[]
            {
                text
            });
            outputObject = AssetManager.Instance.loadedBundles[text].LoadAsset(Path.GetFileName(key), type);
