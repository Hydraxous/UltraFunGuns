...
namespace UltraFunGuns
{
    public static class CustomStyleDefinitions
    {
        ...
        public const string WICKED_KILL = "<color=#919191>NOT WICKED ENOUGH</color>";
        public const string MINOS_KILL = "<color=#03ffa7>JUDGED</color>";
        public const string ORBITED = "ORBITAL LAUNCH";
        public const string EGGED = "EGGED";
        public const string EGG_STRIKE = "TACTICAL EGG STRIKE";
        public const string EGG_SPLOSION = "<color=yellow>EGGSPLOSION</color>";
        public const string LASER_REFRACTION_HIT = "BUG ZAPPER";
        public const string LASER_DISCO_HIT = "DISCO INFERNO";
        public const string DODGEBALL_HIT = "OUTPLAYED";
        public const string DODGEBALL_PARRY = "BOOST BALL";
